...
import MealUpdateForm from "../form/MealUpdateForm";
const UpdateModal = ({ isOpen, setIsUpdateModalOpen, updateMeal }) => {
  return (
    <>
      <Dialog
        open={isOpen}
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div className="mt-2 w-full">
                <MealUpdateForm updateMeal={updateMeal} setIsUpdateModalOpen={setIsUpdateModalOpen}></MealUpdateForm>
              </div>
            </DialogPanel>
          </div>
        </div>
